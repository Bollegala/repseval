...
def cli():
    ...
    Catch the arguments.
    """
    parser = argparse.ArgumentParser(description="Evaluate pre-trained word representation on semantic similarity, \
                                                word analogy, relation classification, short-text classification, \
    ...
    parser.add_argument("-m", nargs="+", 
        help="mode of operation. lex for semantic similarity,\
              ana for analogy, rel for relation classification,\
              txt for text classification and psy for psycholingustic score prediction.\
              pos for part-of-speech tagging, and all for all tasks.\
              Use a space to  specify multiple options.")
